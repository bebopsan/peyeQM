...
Point(6) = {0.460000, 0.460000, 0, 1.0};
Point(7) = {0.540000, 0.460000, 0, 1.0};
Point(8) = {0.540000, 0.540000, 0, 1.0};
Point(9) = {0.460000, 0.540000, 0, 1.0};
Point(10) = {0.429289, 0.429289, 0, 1.0};
Point(11) = {0.570711, 0.429289, 0, 1.0};
Point(12) = {0.570711, 0.570711, 0, 1.0};
Point(13) = {0.429289, 0.570711, 0, 1.0};
Line(2) = {1, 2};
