...
= ['y', 'y', 15, 15, 21, 21, 5], bc_filename = filename +'.bc')  
...
plt.title("Dispersion relations for Square lattice with circular inclusion where r = 0.2a")
