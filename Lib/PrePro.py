...
def Potential1D(Type,X,V0=1,Vleft=0.0,Vright=0.0,width=1,lam=2.,D=1):
    '''
        ...
        potentials for the solution of Schr�dinger equation.
...
def poschl(X,V0,lam):
    """
"poschl":       Potential Well defined by G.P�schl and Edward Teller
                  described in:
                    http://en.wikipedia.org/wiki/P�schl-Teller_potential
